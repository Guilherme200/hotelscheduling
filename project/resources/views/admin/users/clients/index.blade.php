...
@section('content')
  <data-list
    data-source="{{ route('pagination.admin.clients') }}"
        ...
        <div class="card-body p-0">
          <div class="table-responsive">
            <table class="table table-striped table-md table-vcenter mb-0">
              <thead>
              @include('admin.users.clients._partials.head')
              </thead>
              <tbody>
              <tr v-if="emptyResult">
              ...
              <template v-else>
                <tr v-for="(item, index) in items" :key="index">
                  @include('admin.users.clients._partials.body')
                </tr>
              </template>
              </tbody>
            </table>
